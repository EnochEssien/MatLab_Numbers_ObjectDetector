%Numerical detection & AlexNet classification
%Author: Enoch Essien
%Email: enochessien05@gmail.com
...
dataPathname = 'D:\Robotics Course\ADV Machine\datastore';



% Loads the alexnet network into the variable
...
[imsTrain,imsTest] = splitEachLabel(dataStore,0.75,'randomized');
% modify layers
layers = anet.Layers;
...
options = trainingOptions('sgdm',... % use gradient descent (with momentum)
    ...
    'MiniBatchSize',154,... % number of images used per mini-batch 
